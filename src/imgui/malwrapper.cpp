...
void ImGui_ImplGlfw_MouseButtonCallback(CyclopsViewer*, int button, int action, int /*mods*/)
{
//    if (action == GLFW_PRESS && button >= 0 && button < 3)
//        g_MousePressed[button] = true;
}

void ImGui_ImplGlfw_ScrollCallback(CyclopsViewer*, double /*xoffset*/, double yoffset)
{
//    g_MouseWheel += (float)yoffset; // Use fractional mouse wheel, 1.0 unit 5 lines.
}

void ImGui_ImplGlFw_KeyCallback(CyclopsViewer*, int key, int, int action, int mods)
{
...
void ImGui_ImplGlfw_CharCallback(CyclopsViewer*, unsigned int c)
{
//    ImGuiIO& io = ImGui::GetIO();
//    if (c > 0 && c < 0x10000)
